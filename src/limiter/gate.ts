...
export class ConcurrencyGate {
  ...
  getStats(snapshot: UsageSnapshot): GateStats {
    ...
    return {
      ...
      weightedRequestsInWindow: snapshot.weightedRequestsInWindow,
      weightedRemainingRequests: snapshot.weightedRemainingRequests,
      requestsLimit: snapshot.requestsLimit,
      requestsHardCap: snapshot.requestsHardCap,
