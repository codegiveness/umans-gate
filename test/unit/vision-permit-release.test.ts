// Unit tests for src/vision — permit released in finally when post-fetch processing throws.
//
...
describe("permit released in finally when post-fetch processing throws", () => {
