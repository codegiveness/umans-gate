// Unit tests for src/vision — classify GateError separately from fetch errors in vision.
//
// Verifies that callVisionRecorded:
//   1. GateError("circuit_open")  -> status "gate_rejected"
...
//   5. When acquire throws, the permit is null (not leaked)
...
describe("classify GateError separately from fetch errors", () => {
