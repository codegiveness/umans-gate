...
2. **Vision strategy and non-Claude Code harnesses.** Vision handoff is
   currently disabled by default (`VISION_STRATEGY=never`, see "Vision
   handoff temporarily disabled" below) — images pass through untouched.
